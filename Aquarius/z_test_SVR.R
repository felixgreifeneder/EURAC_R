...
#load SVR models
load("X:/Workspaces/GrF/Processing/SCA_paper/era_valdiation_svr/Aquarius_with_means/ascat/SVRmodel_performance.dat")
SVRtuning_ascat <- SVRtuning
load("X:/Workspaces/GrF/Processing/SCA_paper/era_valdiation_svr/Aquarius_with_means/ascat_slope/SVRmodel_performance.dat")
SVRtuning_slope <- SVRtuning
load("X:/Workspaces/GrF/Processing/SCA_paper/era_valdiation_svr/Aquarius_with_means/ascat_aqu/SVRmodel_performance.dat")
SVRtuning_aqu <- SVRtuning


#estimate SMC
tunedModel <- SVRtuning_ascat$best.model
SMCpredicted_ascat <- parallel_predictions(tunedModel, testset)
tunedModel <- SVRtuning_slope$best.model
SMCpredicted_slope <- parallel_predictions(tunedModel, testset)
tunedModel <- SVRtuning_aqu$best.model
SMCpredicted_aqu <- parallel_predictions(tunedModel, testset)
...
outdir <- "X:/Workspaces/GrF/Processing/SCA_paper/era_valdiation_svr/Aquarius_with_means/"
